...
public class Dolphin extends WaterAnimal{
	...
	Dolphin(String name, String gender, double weight, double speed, int x,int y, double diveDept, WaterType watertype) {
	...
	public String toString() {
		return (super.toString() + " " + this.get_WaterType() + " \n");
	}
	private WaterType get_WaterType() {return this.watertype;};
